<?php
    ...
    $total_query = "SELECT COUNT(*) as total FROM contact";  // Assuming table is 'contact'
    $total_result = $conn->query($total_query);
    $total_row = $total_result->fetch_assoc();
    $total_records = $total_row['total'];
    $total_pages = ceil($total_records / $limit);

    // Get the contact messages for the current page
    $query = "SELECT * FROM contact LIMIT $limit OFFSET $offset";  // Assuming table is 'contact'
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Message Submitted At</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <form method="POST" action="../function/php/contact.php" style="display:inline;">
