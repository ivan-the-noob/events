...
<div class="">   
        <div class="navbar flex-column  shadow-sm p-3 collapse show" id="navbar">
            ...
            <div class="navbar-links">
                ...
                <a href="calendar.php" class="navbar-highlight">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="number" id="guess-count" name="guest_count"
                                                class="form-control" placeholder="Enter your text here" min="1"
                                    ...
                                    <div class="col-md-4 mt-4">
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text" id="event-endtime" name="event_endtime"
                                                class="form-control" placeholder="End time" readonly>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group mt-4" id="event-options-group" style="display: none;">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="pax-50"
                                                    name="event_options[]" value="50 Pax">
                                                <label class="form-check-label" for="pax-50">50 Pax Package</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="pax-60"
                                                    name="event_options[]" value="60 Pax">
                                                <label class="form-check-label" for="pax-60">60 Pax Package</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="pax-70"
                                                    name="event_options[]" value="70 Pax">
                                                <label class="form-check-label" for="pax-70">70 Pax Package</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="pax-80"
                                                    name="event_options[]" value="80 Pax">
                                                <label class="form-check-label" for="pax-80">80 Pax Package</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="pax-100"
                                                    name="event_options[]" value="100 Pax">
                                                <label class="form-check-label" for="pax-100">100 Pax Package</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="pax-150"
                                                    name="event_options[]" value="150 Pax">
                                                <label class="form-check-label" for="pax-150">150 Pax Package</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="pax-200"
                                                    name="event_options[]" value="200 Pax">
                                                <label class="form-check-label" for="pax-200">200 Pax Package</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="photobooth"
                                                    name="event_options[]" value="Photobooth">
                                                <label class="form-check-label" for="photobooth">Photobooth</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="clowns"
                                                    name="event_options[]" value="Clowns">
                                                <label class="form-check-label" for="clowns">Clowns</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="magicians"
                                                    name="event_options[]" value="Magicians">
                                                <label class="form-check-label" for="magicians">Magicians</label>
                                            </div>

                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="grazing-table"
                                                    name="event_options[]" value="Grazing Table">
                                                <label class="form-check-label" for="grazing-table">Grazing
                                                    Table</label>
                                            </div>
                                        </div>
