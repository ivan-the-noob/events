            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="printContent-<?php echo $row['id']; ?>">
                    <div class="headers d-flex justify-content-center mx-auto mb-4">
                        <div>
                            <img src="../../../assets/logo.png" alt="Logo" style="width: 100px; height: 100px; display: block; margin: auto;"> 
                    ...
                    <div class="col-md-12 d-flex justify-content-center align-items-center">
                        <div>
                            ...
                            <div class="info-row">
                                ...
                                <div class="info-right">₱<?php echo number_format(max(0, $row['cost'] - $row['payment_amount'] - $row['add_payment']), 2); ?></div>
                            </div>
                            <div class="info-row">
