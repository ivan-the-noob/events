...
<div class="">   
        <div class="navbar flex-column shadow-sm p-3 collapse show" id="navbar">
            ...
            <div class="navbar-links">
                ...
                <a href="refund.php" class="navbar-highlight">
                        ...
                        while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <form method="POST" action="../function/php/approve_refund.php" id="refundForm">
                                    ...
                                    <select class="form-select" id="refundDropdown" style="width: 200px;" onchange="updateRefundAmount()">
...
<script>
    ...
    const paymentAmount = <?php echo $row['payment_amount']; ?>;

    function updateRefundAmount() {
        const refundDropdown = document.getElementById("refundDropdown");
        const selectedOption = refundDropdown.value;
        let refundAmount = 0;
        ...
        // Update the hidden refunded_amount field and show the refund amount in the modal
        document.getElementById("refunded_amount").value = refundAmount;
        document.getElementById("refundAmountDisplay").innerText = refundAmount.toFixed(2);

        // Set the refund status based on selection
        document.getElementById("refund_status").value = selectedOption;
    }
