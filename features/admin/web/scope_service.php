...
$query = "SELECT * FROM scope_services";
...
<head>
    ...
    <title>Scope Service| Admin</title>
        ...
        <div class="container mt-4">
                ...
                <?php if ($result->num_rows > 0): ?>
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <img src="../../../assets/scope/<?php echo htmlspecialchars($row['image']); ?>" 
            ...
            <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="../function/php/add_service.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <form action="../function/php/update_service.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-content">
                            <div class="modal-header">
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                ...
                <script>
                 ...
                 document.querySelectorAll('[data-bs-toggle="modal"][data-bs-target="#editModal"]').forEach(button => {
                    button.addEventListener('click', function () {
                        ...
                        document.querySelector('#editModal #edit_image_display').src = "../../../assets/scope/" + image; 
                    });
                });
                ...
                function deleteService(id) {
                    ...
                    document.getElementById('delete_confirm_btn').href = `../function/php/delete_service.php?id=${id}`;
                    deleteModal.show();
                }
